...
<html>
    ...
    <body>
        ...
        <div class="center">
            ...
            <form action="Add Successfully.jsp" method="POST" align="center">
                <h2>First Name :- </h2><input required type="text" name="first" size="40" maxlength="15" /><br/>
                <h2>Last Name :- </h2><input required type="text" name="last" size="40" maxlength="15" /><br/>
                ...
                <h2>Address :-</h2><textarea required name="add"></textarea><br/>
                <h2>State :- </h2>
                ...
                <h2>Date of Joining :- </h2><input required type="date" name="doj" size="10"/><br/>
